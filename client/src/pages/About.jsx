  ...
  return (
    <div className='text-gray-700'>
      ...
      <div className='flex gap-5 items-center w-full'>
        <img className='w-1/3 rounded-2xl' src={assets.VNR} alt="" />
        <div className='flex text-xl font-light text-justify flex-col items-baseline gap-5'>
      ...
      <div className='mt-10 mb-20 text-gray-700'>
        ...
        <div className='flex gap-0 w-full mx-7 items-center mt-5'>
          <div className='w-1/3 p-10 border border-gray-500 hover:bg-gray-600 hover:text-white transition-all duration-200'>
            <p className='font-medium font-medium pb-3'>
              EFFICIENCY
            </p>
            <p>
